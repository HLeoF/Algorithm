/*
* Author: Maiqi Hou
* Assignment 5.1: UN Problem
* Assignment Description:
        This program gives the size of the smallest set 
        of members S that should be asked to leave so 
        that all remaining pairs of members can converse.
* Due Date: 7/12/2021
